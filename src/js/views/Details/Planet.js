				...
				<div className="card planet my-0">
					<div className="row">
						<div className="col-md-6 planet-img">
							<div className="row">
								<img
									src={`/img/planets/${loadPicture(planets.data.result.properties.name)}`}
									className="img-fluid"
									alt={`img of ${planets.data.result.properties.name}`}
								/>
							</div>
							<div className="row">
						...
						<div className="col-md-6">
							<div className="card-body">
								<h3 className="card-title text-center">{planets.data.result.properties.name}</h3>
								<ul className="list-group text-center">
									<li className="list-group-item d-flex">
										Climate: {planets.result.properties.climate}
									</li>
									<li className="list-group-item d-flex">
										Gravity: {planets.result.properties.gravity}
									</li>
									<li className="list-group-item d-flex">
									...
									<li className="list-group-item d-flex">
										Surface Water: {planets.result.properties.surface_water}
									</li>
									<li className="list-group-item d-flex">
										Population: {planets.result.properties.population}
									</li>
									<li className="list-group-item d-flex">
										Orbital Period: {planets.result.properties.orbital_period}
									</li>
									<li className="list-group-item d-flex">
										rotation_period: {planets.result.properties.rotation_period}
									</li>
								</ul>
							</div>
						</div>
